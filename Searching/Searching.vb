...
Function LinearSearchUnsorted(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer) As Boolean
...
Function LinearSearchSorted(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer) As Boolean
    For i As Integer = 0 To size - 1
        If value = arr(i) Then
            Return True
...
Function BinarySearch(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer) As Boolean
...
Function BinarySearchRec(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer) As Boolean
    Dim low As Integer = 0
    Dim high As Integer = size - 1
    Return BinarySearchRecUtil(arr, low, high, value)
End Function

Function BinarySearchRecUtil(ByVal arr As Integer(), ByVal low As Integer, ByVal high As Integer, ByVal value As Integer) As Boolean
    If low > high Then
        Return False
    End If
...
Function BinarySearch(ByVal arr As Integer(), ByVal start As Integer, ByVal finish As Integer, ByVal key As Integer, ByVal isInc As Boolean) As Integer
    Dim mid As Integer
...
Function FibonacciSearch(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer) As Boolean
...
Function FirstRepeated(ByVal arr As Integer(), ByVal size As Integer) As Integer
    For i As Integer = 0 To size - 1
...
Function FirstRepeated2(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Sub PrintRepeating(ByVal arr As Integer(), ByVal size As Integer)
...
Sub PrintRepeating2(ByVal arr As Integer(), ByVal size As Integer)
    Array.Sort(arr)
    Console.Write("Repeating elements are ")
...
Sub PrintRepeating3(ByVal arr As Integer(), ByVal size As Integer)
...
Sub PrintRepeating4(ByVal arr As Integer(), ByVal size As Integer, ByVal range As Integer)
...
Function RemoveDuplicates(ByVal arr() As Integer, ByVal size As Integer) As Integer()
    Dim j As Integer = 0
    Array.Sort(arr)
    For i As Integer = 1 To size - 1
        If arr(i) <> arr(j) Then
...
Function RemoveDuplicates2(ByVal arr As Integer(), ByVal size As Integer) As Integer()
    Dim hm As Dictionary(Of Integer, Integer) = New Dictionary(Of Integer, Integer)()
    Dim j As Integer = 0
    For i As Integer = 0 To size - 1
...
Function FindMissingNumber(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function FindMissingNumber2(ByVal arr As Integer(), ByVal size As Integer) As Integer
    Array.Sort(arr)
    For i As Integer = 0 To size - 1
        If arr(i) <> i + 1 Then
            Return i + 1
...
Function FindMissingNumber3(ByVal arr As Integer(), ByVal size As Integer) As Integer
    Dim hm As Dictionary(Of Integer, Integer) = New Dictionary(Of Integer, Integer)()
    For i As Integer = 0 To size - 1
        hm(arr(i)) = 1
    Next
...
Function FindMissingNumber4(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function FindMissingNumber5(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function FindMissingNumber6(ByVal arr As Integer(), ByVal size As Integer) As Integer
    For i As Integer = 0 To size - 1
...
Function FindMissingNumber7(ByVal arr As Integer(), ByVal size As Integer) As Integer
    Dim i As Integer
...
Function FindMissingNumber8(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Sub MissingValues(ByVal arr As Integer(), ByVal size As Integer)
...
Sub MissingValues2(ByVal arr As Integer(), ByVal size As Integer)
    Array.Sort(arr)
...
Sub MissingValues3(ByVal arr As Integer(), ByVal size As Integer)
...
Sub OddCount(ByVal arr As Integer(), ByVal size As Integer)
    Dim xorSum As Integer = 0
    For i As Integer = 0 To size - 1
        xorSum = xorSum Xor arr(i)
    Next
...
Sub OddCount2(ByVal arr As Integer(), ByVal size As Integer)
    Dim hm As Dictionary(Of Integer, Integer) = New Dictionary(Of Integer, Integer)()
...
Sub OddCount3(ByVal arr As Integer(), ByVal size As Integer)
    Dim xorSum As Integer = 0
...
Sub SumDistinct(ByVal arr As Integer(), ByVal size As Integer)
    Dim sum As Integer = 0
    Array.Sort(arr)
...
Sub MinAbsSumPair(ByVal arr As Integer(), ByVal size As Integer)
...
Sub MinAbsSumPair2(ByVal arr As Integer(), ByVal size As Integer)
    Dim l, r, minSum, sum, minFirst, minSecond As Integer
    If size < 2 Then
        Console.WriteLine("Invalid Input")
        Return
...
Function FindPair(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer) As Boolean
    For i As Integer = 0 To size - 1
        For j As Integer = i + 1 To size - 1
...
Function FindPair2(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer) As Boolean
...
Function FindPair3(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer) As Boolean
    Dim hs As HashSet(Of Integer) = New HashSet(Of Integer)()
...
Function FindPair4(ByVal arr As Integer(), ByVal size As Integer, ByVal range As Integer, ByVal value As Integer) As Boolean
...
Function FindPairTwoLists(ByVal arr1 As Integer(), ByVal size1 As Integer, ByVal arr2 As Integer(), ByVal size2 As Integer, ByVal value As Integer) As Boolean
...
Function FindPairTwoLists2(ByVal arr1 As Integer(), ByVal size1 As Integer, ByVal arr2 As Integer(), ByVal size2 As Integer, ByVal value As Integer) As Boolean
    Array.Sort(arr2)
    For i As Integer = 0 To size1 - 1
...
Function FindPairTwoLists3(ByVal arr1 As Integer(), ByVal size1 As Integer, ByVal arr2 As Integer(), ByVal size2 As Integer, ByVal value As Integer) As Boolean
...
Function FindPairTwoLists4(ByVal arr1 As Integer(), ByVal size1 As Integer, ByVal arr2 As Integer(), ByVal size2 As Integer, ByVal value As Integer) As Boolean
    Dim hs As HashSet(Of Integer) = New HashSet(Of Integer)()
...
Function FindPairTwoLists5(ByVal arr1 As Integer(), ByVal size1 As Integer, ByVal arr2 As Integer(), ByVal size2 As Integer, ByVal range As Integer, ByVal value As Integer) As Boolean
    Dim count As Integer() = New Integer(range) {}
    For i As Integer = 0 To range
        count(i)= 0
    Next i
...
Function FindDifference(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer) As Boolean
    For i As Integer = 0 To size - 1
        For j As Integer = i + 1 To size - 1
...
Function FindDifference2(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer) As Boolean
    Dim first As Integer = 0
    Dim second As Integer = 0
    Dim diff As Integer
    Array.Sort(arr)
...
Function FindMinDiff(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function FindMinDiff2(ByVal arr As Integer(), ByVal size As Integer) As Integer
    Array.Sort(arr)
    Dim diff As Integer = Integer.MaxValue
...
Function MinDiffPair(ByVal arr1 As Integer(), ByVal size1 As Integer, ByVal arr2 As Integer(), ByVal size2 As Integer) As Integer
    Dim diff As Integer = Integer.MaxValue
    Dim first As Integer = 0
    Dim second As Integer = 0
...
Function MinDiffPair2(ByVal arr1 As Integer(), ByVal size1 As Integer, ByVal arr2 As Integer(), ByVal size2 As Integer) As Integer
...
Sub ClosestPair(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer)
...
Sub ClosestPair2(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer)
...
Function SumPairRestArray(ByVal arr As Integer(), ByVal size As Integer) As Boolean
...
Sub ZeroSumTriplets(ByVal arr As Integer(), ByVal size As Integer)
...
Sub ZeroSumTriplets2(ByVal arr As Integer(), ByVal size As Integer)
...
Sub FindTriplet(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer)
    For i As Integer = 0 To (size - 2) - 1
        For j As Integer = i + 1 To (size - 1) - 1
            For k As Integer = j + 1 To size - 1
...
Sub FindTriplet2(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer)
    Dim start, finish As Integer
    Array.Sort(arr)
    For i As Integer = 0 To size - 2 - 1
        start = i + 1
...
Sub AbcTriplet(ByVal arr As Integer(), ByVal size As Integer)
    For i As Integer = 0 To size - 1 - 1
        For j As Integer = i + 1 To size - 1
...
Sub AbcTriplet2(ByVal arr As Integer(), ByVal size As Integer)
    Dim start, finish As Integer
    Array.Sort(arr)
    For i As Integer = 0 To size - 1
        start = 0
...
Sub SmallerThenTripletCount(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer)
...
Sub SmallerThenTripletCount2(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer)
    Dim start, finish As Integer
    Dim count As Integer = 0
    Array.Sort(arr)
...
Sub APTriplets(ByVal arr As Integer(), ByVal size As Integer)
...
Sub GPTriplets(ByVal arr As Integer(), ByVal size As Integer)
    Dim i, j, k As Integer
...
Function NumberOfTriangles(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function NumberOfTriangles2(ByVal arr As Integer(), ByVal size As Integer) As Integer
    Dim i, j, k As Integer, count As Integer = 0
    Array.Sort(arr)
...
Function GetMax(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function GetMax2(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function GetMax3(ByVal arr As Integer(), ByVal size As Integer, ByVal range As Integer) As Integer
    Dim max As Integer = arr(0), maxCount As Integer = 1
    Dim count As Integer() = New Integer(range - 1) {}
...
Function GetMajority(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function GetMajority2(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function GetMajority3(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function GetMedian(ByVal arr As Integer(), ByVal size As Integer) As Integer
    Array.Sort(arr)
    Return arr(size \ 2)
End Function

Function GetMedian2(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Sub Main27()
    ...
    Console.WriteLine(GetMedian2(first, first.Length))
End Sub
'	6

Function SearchBitonicArrayMax(ByVal arr As Integer(), ByVal size As Integer) As Integer
    For i As Integer = 0 To size - 2 - 1
        If arr(i) > arr(i + 1) Then
            Return arr(i)
        End If
...
Function SearchBitonicArrayMax2(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function SearchBitonicArray(ByVal arr As Integer(), ByVal size As Integer, ByVal key As Integer) As Integer
...
Function findMaxBitonicArray(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function FindKeyCount(ByVal arr As Integer(), ByVal size As Integer, ByVal key As Integer) As Integer
    Dim count As Integer = 0
    For i As Integer = 0 To size - 1
        If arr(i) = key Then
            count += 1
...
Function FindFirstIndex(ByVal arr As Integer(), ByVal start As Integer, ByVal finish As Integer, ByVal key As Integer) As Integer
    Dim mid As Integer
    If finish < start Then
        Return -1
    End If
...
Function FindLastIndex(ByVal arr As Integer(), ByVal start As Integer, ByVal finish As Integer, ByVal key As Integer) As Integer
    If finish < start Then
        Return -1
    End If
...
Function FindKeyCount2(ByVal arr As Integer(), ByVal size As Integer, ByVal key As Integer) As Integer
...
Function FirstIndex(ByVal arr As Integer(), ByVal size As Integer, ByVal low As Integer, ByVal high As Integer, ByVal value As Integer) As Integer
...
Function IsMajority2(ByVal arr As Integer(), ByVal size As Integer) As Boolean
...
Function IsMajority(ByVal arr As Integer(), ByVal size As Integer) As Boolean
    Dim count As Integer = 0
...
Function MaxProfit(ByVal stocks As Integer(), ByVal size As Integer) As Integer
...
Function MaxProfit2(ByVal stocks As Integer(), ByVal size As Integer) As Integer
    Dim buy As Integer = 0, sell As Integer = 0
...
Function FindMedian(ByVal arrFirst As Integer(), ByVal sizeFirst As Integer, ByVal arrSecond As Integer(), ByVal sizeSecond As Integer) As Integer
...
Function Search01(ByVal arr As Integer(), ByVal size As Integer) As Integer
    For i As Integer = 0 To size - 1
        If arr(i) = 1 Then
            Return i
        End If
...
Function BinarySearch01(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function BinarySearch01Util(ByVal arr As Integer(), ByVal start As Integer, ByVal finish As Integer) As Integer
    If finish < start Then
        Return -1
    End If
...
Function RotationMax(ByVal arr As Integer(), ByVal size As Integer) As Integer
    For i As Integer = 0 To size - 1 - 1
        If arr(i) > arr(i + 1) Then
            Return arr(i)
        End If
...
Function RotationMaxUtil(ByVal arr As Integer(), ByVal start As Integer, ByVal finish As Integer) As Integer
    If finish <= start Then
        Return arr(start)
    End If
...
Function RotationMax2(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function FindRotationMax(ByVal arr As Integer(), ByVal size As Integer) As Integer
    For i As Integer = 0 To size - 1 - 1
        If arr(i) > arr(i + 1) Then
            Return i
        End If
...
Function FindRotationMaxUtil(ByVal arr As Integer(), ByVal start As Integer, ByVal finish As Integer) As Integer
    If finish <= start Then
        Return start
    End If
...
Function FindRotationMax2(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function CountRotation(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function SearchRotateArray(ByVal arr As Integer(), ByVal size As Integer, ByVal key As Integer) As Integer
    For i As Integer = 0 To size - 1 - 1
        If arr(i) = key Then
            Return i
        End If
...
Function BinarySearchRotateArrayUtil(ByVal arr As Integer(), ByVal start As Integer, ByVal finish As Integer, ByVal key As Integer) As Integer
    If finish < start Then
        Return -1
    End If
...
Function BinarySearchRotateArray(ByVal arr As Integer(), ByVal size As Integer, ByVal key As Integer) As Integer
...
Function MinAbsDiffAdjCircular(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Sub Swapch(ByVal arr As Char(), ByVal first As Integer, ByVal second As Integer)
    Dim temp As Char = arr(first)
    arr(first) = arr(second)
    arr(second) = temp
End Sub

Sub TransformArrayAB1(ByVal arr As Char(), ByVal size As Integer)
...
Function CheckPermutation(ByVal array1 As Char(), ByVal size1 As Integer, ByVal array2 As Char(), ByVal size2 As Integer) As Boolean
    If size1 <> size2 Then
        Return False
    End If
...
Function CheckPermutation2(ByVal arr1 As Char(), ByVal size1 As Integer, ByVal arr2 As Char(), ByVal size2 As Integer) As Boolean
    If size1 <> size2 Then
        Return False
    End If
...
Function CheckPermutation3(ByVal array1 As Char(), ByVal size1 As Integer, ByVal array2 As Char(), ByVal size2 As Integer) As Boolean
    If size1 <> size2 Then
        Return False
    End If
...
Function FindElementIn2DArray(ByVal arr As Integer(,), ByVal r As Integer, ByVal c As Integer, ByVal value As Integer) As Boolean
...
Function IsAP(ByVal arr As Integer(), ByVal size As Integer) As Boolean
    If size <= 1 Then
        Return True
    End If
...
Function IsAP2(ByVal arr As Integer(), ByVal size As Integer) As Boolean
...
Function IsAP3(ByVal arr As Integer(), ByVal size As Integer) As Boolean
    Dim first As Integer = 9999999
    Dim second As Integer = 9999999
...
Function FindBalancedPoint(ByVal arr As Integer(), ByVal size As Integer) As Integer
    Dim first As Integer = 0
    Dim second As Integer = 0
...
Function FindFloor(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer) As Integer
    Dim start As Integer = 0
    Dim finish As Integer = size - 1
    Dim mid As Integer
...
Function FindCeil(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer) As Integer
    Dim start As Integer = 0
    Dim finish As Integer = size - 1
    Dim mid As Integer
...
Function ClosestNumber(ByVal arr As Integer(), ByVal size As Integer, ByVal num As Integer) As Integer
    Dim start As Integer = 0
    Dim finish As Integer = size - 1
...
Function DuplicateKDistance(ByVal arr As Integer(), ByVal size As Integer, ByVal k As Integer) As Boolean
    Dim hm As Dictionary(Of Integer, Integer) = New Dictionary(Of Integer, Integer)()
...
Sub FrequencyCounts(ByVal arr As Integer(), ByVal size As Integer)
    Dim hm As Dictionary(Of Integer, Integer) = New Dictionary(Of Integer, Integer)()
...
Sub FrequencyCounts2(ByVal arr As Integer(), ByVal size As Integer)
    Array.Sort(arr)
...
Sub FrequencyCounts3(ByVal arr As Integer(), ByVal size As Integer)
...
Sub FrequencyCounts4(ByVal arr As Integer(), ByVal size As Integer)
...
Sub KLargestElements(ByVal arrIn As Integer(), ByVal size As Integer, ByVal k As Integer)
...
Sub KLargestElements2(ByVal arrIn As Integer(), ByVal size As Integer, ByVal k As Integer)
    Dim arr As Integer() = New Integer(size - 1) {}
    For i As Integer = 0 To size - 1
        arr(i) = arrIn(i)
    Next
...
Function FixPoint(ByVal arr As Integer(), ByVal size As Integer) As Integer
    For i As Integer = 0 To size - 1
        If arr(i) = i Then
            Return i
        End If
...
Function FixPoint2(ByVal arr As Integer(), ByVal size As Integer) As Integer
    Dim low As Integer = 0
    Dim high As Integer = size - 1
    Dim mid As Integer
...
Sub SubArraySums(ByVal arr As Integer(), ByVal size As Integer, ByVal value As Integer)
...
Function MaxConSub(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function MaxConSubArr(ByVal A As Integer(), ByVal sizeA As Integer, ByVal B As Integer(), ByVal sizeB As Integer) As Integer
...
Function MaxConSubArr2(ByVal A As Integer(), ByVal sizeA As Integer, ByVal B As Integer(), ByVal sizeB As Integer) As Integer
    Array.Sort(B)
    Dim currMax As Integer = 0
    Dim maximum As Integer = 0
...
Function RainWater(ByVal arr As Integer(), ByVal size As Integer) As Integer
...
Function RainWater2(ByVal arr As Integer(), ByVal size As Integer) As Integer
    Dim water As Integer = 0
...
Sub SeparateEvenAndOdd(ByVal arr As Integer(), ByVal size As Integer)
