...
Module Module1
    ...
    Public Function SumArray(ByVal arr() As Integer) As Integer
    ...
    Public Function SequentialSearch(ByVal arr() As Integer, ByVal size As Integer, ByVal value As Integer) As Integer
    ...
    Public Function BinarySearch(ByVal arr() As Integer, ByVal size As Integer, ByVal value As Integer) As Integer
        Dim mid As Integer
    ...
    Public Sub rotateArray(ByVal a() As Integer, ByVal n As Integer, ByVal k As Integer)
        reverseArray(a, 0, k - 1)
        reverseArray(a, k, n - 1)
        reverseArray(a, 0, n - 1)
    End Sub

    Public Sub reverseArray(ByVal a() As Integer, ByVal start As Integer, ByVal [end] As Integer)
    ...
    Public Sub reverseArray2(ByVal a() As Integer)
    ...
    Public Function maxSubArraySum(ByVal a() As Integer, ByVal size As Integer) As Integer
    ...
    Public Sub WaveArray2(ByVal arr() As Integer)
        Dim size As Integer = arr.Length
    ...
    Public Sub WaveArray(ByVal arr() As Integer)
        Dim size As Integer = arr.Length
        Array.Sort(arr)
        Dim i As Integer = 0
        Do While i < size - 1
    ...
    Public Sub indexArray(ByVal arr() As Integer, ByVal size As Integer)
        For i As Integer = 0 To size - 1
    ...
    Public Sub indexArray2(ByVal arr() As Integer, ByVal size As Integer)
        Dim temp As Integer
        For i As Integer = 0 To size - 1
    ...
    Public Sub Sort1toN(ByVal arr() As Integer, ByVal size As Integer)
    ...
    Public Sub Sort1toN2(ByVal arr() As Integer, ByVal size As Integer)
        Dim temp As Integer
        For i As Integer = 0 To size - 1
    ...
    Public Function SmallestPositiveMissingNumber(ByVal arr() As Integer, ByVal size As Integer) As Integer
    ...
    Public Function SmallestPositiveMissingNumber2(ByVal arr() As Integer, ByVal size As Integer) As Integer
    ...
    Public Function SmallestPositiveMissingNumber3(ByVal arr() As Integer, ByVal size As Integer) As Integer
    ...
    Public Function SmallestPositiveMissingNumber4(ByVal arr() As Integer, ByVal size As Integer) As Integer
        Dim temp As Integer
        For i As Integer = 0 To size - 1
    ...
    Public Sub ReverseArr(ByVal arr() As Integer, ByVal start As Integer, ByVal [stop] As Integer)
        Do While start < [stop]
            swap(arr, start, [stop])
            start += 1
            [stop] -= 1
    ...
    Public Sub MaxMinArr2(ByVal arr() As Integer, ByVal size As Integer)
        Dim i As Integer = 0
        Do While i < (size - 1)
    ...
    Public Function maxCircularSum(ByVal arr() As Integer, ByVal size As Integer) As Integer
    ...
    Public Function ArrayIndexMaxDiff(ByVal arr() As Integer, ByVal size As Integer) As Integer
    ...
    Public Function ArrayIndexMaxDiff2(ByVal arr() As Integer, ByVal size As Integer) As Integer
    ...
    Public Function maxPathSum(ByVal arr1() As Integer, ByVal size1 As Integer, ByVal arr2() As Integer, ByVal size2 As Integer) As Integer
    ...
    Public Sub towerOfHanoi(ByVal num As Integer, ByVal src As Char, ByVal dst As Char, ByVal temp As Char)
        If num < 1 Then
            Return
        End If
    ...
    Public Sub permutation(ByVal arr() As Integer, ByVal i As Integer, ByVal length As Integer)
        If length = i Then
    ...
    Public Function BinarySearchRecursive(ByVal arr() As Integer, ByVal low As Integer, ByVal high As Integer, ByVal value As Integer) As Integer
        If low > high Then
            Return -1
        End If
