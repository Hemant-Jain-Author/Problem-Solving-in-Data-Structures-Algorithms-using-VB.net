...
Public Class QuickSort
	Private Shared Sub qSort(ByVal arr() As Integer, ByVal lower As Integer, ByVal upper As Integer)
		If upper <= lower Then
			Return
		End If
		...
		qSort(arr, start, upper - 1) ' pivot -1 is the upper for left sub array.
		qSort(arr, upper + 1, [stop]) ' pivot + 1 is the lower for right sub array
	End Sub
