...
Public Class SortingEx
	...
	Friend Function minSwaps(ByVal arr() As Integer, ByVal size As Integer, ByVal val As Integer) As Integer
	...
	Public Shared Sub seperateEvenAndOdd(ByVal data() As Integer, ByVal size As Integer)
	...
	Public Shared Function AbsMore(ByVal value1 As Integer, ByVal value2 As Integer, ByVal reference As Integer) As Boolean
		Return (Math.Abs(value1 - reference) > Math.Abs(value2 - reference))
	End Function

	Public Shared Sub AbsBubbleSort(ByVal arr() As Integer, ByVal size As Integer, ByVal reference As Integer)
		Dim i As Integer = 0
		Do While i < (size - 1)
			Dim j As Integer = 0
			Do While j < (size - i - 1)
	...
	Public Shared Sub Main100(ByVal args() As String)
