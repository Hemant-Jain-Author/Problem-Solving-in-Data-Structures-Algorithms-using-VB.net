...
Public Class Algo
	...
	Public Shared Sub Main(ByVal args() As String)
		...
		Dim algo_Renamed As New Algo()
		Console.WriteLine("BruteForceSearch return : " & algo_Renamed.bruteForceSearch(st1, st2))
		Console.WriteLine("RobinKarp return : " & algo_Renamed.robinKarp(st1, st2))
		Console.WriteLine("KMP return : " & algo_Renamed.KMP(st1, st2))
	End Sub
End Class