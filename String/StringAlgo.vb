...
Public Class StringAlgo
	Public Shared Function matchExpUtil(ByVal exp() As Char, ByVal str() As Char, ByVal i As Integer, ByVal j As Integer) As Boolean
	...
	Public Shared Sub printAnagram(ByVal a() As Char, ByVal max As Integer, ByVal n As Integer)
		If max = 1 Then
			Console.WriteLine(a)
		End If
	...
	Public Shared Function shuffle(ByVal str As String) As String
	...
	Public Shared Function addBinary(ByVal firstStr As String, ByVal secondStr As String) As Char()
