...
Public Class Algo
	...
	Public Shared Sub Main88(ByVal args() As String)
		...
		Dim algoobject As New Algo()
		Console.WriteLine("BruteForceSearch return : " & algoobject.BruteForceSearch(st1, st2))
		Console.WriteLine("RobinKarp return : " & algoobject.RobinKarp(st1, st2))
		Console.WriteLine("KMP return : " & algoobject.KMP(st1, st2))
	End Sub


	Friend Function BruteForceSearch(ByVal text As String, ByVal pattern As String) As Integer
		Return BruteForceSearch(text.ToCharArray(), pattern.ToCharArray())
	End Function

	Friend Function BruteForceSearch(ByVal text() As Char, ByVal pattern() As Char) As Integer
	...
	Friend Function RobinKarp(ByVal text As String, ByVal pattern As String) As Integer
		Return RobinKarp(text.ToCharArray(), pattern.ToCharArray())
	End Function

	Friend Function RobinKarp(ByVal text() As Char, ByVal pattern() As Char) As Integer
		Dim n As Integer = text.Length
		Dim m As Integer = pattern.Length
		Dim i, j As Integer
	...
	Friend Sub KMPPreprocess(ByVal pattern() As Char, ByVal ShiftArr() As Integer)
		Dim m As Integer = pattern.Length
	...
	Friend Function KMP(ByVal text As String, ByVal pattern As String) As Integer
		Return KMP(text.ToCharArray(), pattern.ToCharArray())
	End Function

	Friend Function KMP(ByVal text() As Char, ByVal pattern() As Char) As Integer
		Dim i As Integer = 0, j As Integer = 0
		Dim n As Integer = text.Length
		Dim m As Integer = pattern.Length
	...
	Friend Function KMPFindCount(ByVal text() As Char, ByVal pattern() As Char) As Integer
