# Problem-Solving-in-Data-Structures-Algorithms-using-VB.net

This is the code repository of book **Problem Solving in Data Structures & Algorithms using VB.net**.

![alt text](https://m.media-amazon.com/images/P/B0BN61ZCPB.jpg)
...
- VB.net solutions are provided with input and output. 
...
- Chapter 3: Abstract Data Type & VB.net Collections
- Chapter 4: Searching
- Chapter 5: Sorting
