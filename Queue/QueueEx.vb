...
Private Shared Sub DistNearestFillUtil(ByVal arr As Integer(,), ByVal maxCol As Integer, ByVal maxRow As Integer, ByVal currCol As Integer, ByVal currRow As Integer, ByVal traversed As Integer(,), ByVal dist As Integer)
    Dim x, y As Integer
    Dim dir As Integer(,) = New Integer(,) {
    {-1, 0},{1, 0},{0, -1},{0, 1}}
