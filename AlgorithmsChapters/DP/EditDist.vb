...
Public Module EditDist
	Function Min(ByVal x As Integer, ByVal y As Integer, ByVal z As Integer) As Integer
		x = Math.Min(x, y)
		Return Math.Min(x, z)
	End Function

	Function FindEditDist(ByVal str1 As String, ByVal str2 As String) As Integer
		Dim m As Integer = str1.Length
		Dim n As Integer = str2.Length
		Return FindEditDist(str1, str2, m, n)
	End Function

	Function FindEditDist(ByVal str1 As String, ByVal str2 As String, ByVal m As Integer, ByVal n As Integer) As Integer
