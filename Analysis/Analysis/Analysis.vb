...
Public Class Analysis
	...
	Friend Overridable Function fun1(ByVal n As Integer) As Integer
		Dim m As Integer = 0
	...
	Friend Overridable Function fun2(ByVal n As Integer) As Integer
	...
	Friend Overridable Function fun3(ByVal n As Integer) As Integer
		Dim i As Integer = 0, j As Integer = 0, m As Integer = 0
		For i = 0 To n - 1
			For j = 0 To i - 1
				m += 1
	...
	Friend Overridable Function fun4(ByVal n As Integer) As Integer
	...
	Friend Overridable Function fun5(ByVal n As Integer) As Integer
		Dim i As Integer = 0, m As Integer = 0
		i = n
		Do While i > 0
			m += 1
	...
	Friend Overridable Function fun6(ByVal n As Integer) As Integer
	...
	Friend Overridable Function fun7(ByVal n As Integer) As Integer
		Dim i As Integer = 0, j As Integer = 0, k As Integer = 0, m As Integer = 0
		i = n
		For i = 0 To n - 1
			For j = 0 To n - 1
	...
	Friend Overridable Function fun8(ByVal n As Integer) As Integer
		Dim i As Integer = 0, j As Integer = 0, m As Integer = 0
		i = 0
		Do While i < n
			j = 0
	...
	Friend Overridable Function fun9(ByVal n As Integer) As Integer
		Dim i As Integer = 0, j As Integer = 0, m As Integer = 0
		i = n
		Do While i > 0
			For j = 0 To i - 1
	...
	Friend Overridable Function fun10(ByVal n As Integer) As Integer
		Dim i As Integer = 0, j As Integer = 0, m As Integer = 0
		For i = 0 To n - 1
			For j = i To 1 Step -1
				m += 1
	...
	Friend Overridable Function fun11(ByVal n As Integer) As Integer
		Dim i As Integer = 0, j As Integer = 0, k As Integer = 0, m As Integer = 0
		For i = 0 To n - 1
			For j = i To n - 1
				For k = j + 1 To n - 1
	...
	Friend Overridable Function fun12(ByVal n As Integer) As Integer
		Dim i As Integer = 0, j As Integer = 0, m As Integer = 0
		For i = 0 To n - 1
			Do While j < n
				m += 1
	...
	Friend Overridable Function fun13(ByVal n As Integer) As Integer
